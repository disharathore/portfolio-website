...
path = '/Users/disha/Desktop/portfolioWebsite/portfolio/app/projects/page.tsx'
...
"                My Projects",
"            </h1>",
'            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-14 pb-20 px-6 mt-10 bg-yellow-200/40 rounded-2xl p-4 shadow-inner shadow-yellow-300/40">',
"                {PROJECTS.map((proj, i) => {",
...
"                                whileTap={CARD_TAP}",
"                                className={cn(",
'                                    "relative text-[var(--c-ink)] min-h-[auto] md:min-h-[450px] font-hand group/card rounded-xl",',
